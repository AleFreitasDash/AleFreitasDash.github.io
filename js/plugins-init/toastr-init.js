...
*******************/
    ...
    $("#WCOPIADO").on("click", function () {
                toastr.success("Espelho Whatsapp", "Copiado!", {
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !6,
                    newestOnTop: !0,
	...
	$("#ECOPIADO").on("click", function () {
                toastr.info("Espelho Email", "Copiado!", {
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !6,
                    newestOnTop: !0,
	...
	$("#TCOPIADO").on("click", function () {
                toastr.info("Espelho Ticket", "Copiado!", {
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !6,
                    newestOnTop: !0,
	...
	$("#NF1COPIADO").on("click", function () {
                toastr.info("Espelho NF Principal", "Copiado!", {
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !6,
                    newestOnTop: !0,
	...
	$("#NF2COPIADO").on("click", function () {
                toastr.info("Espelho NF Simples Remessa", "Copiado!", {
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !6,
                    newestOnTop: !0,
	...
	$("#NF3COPIADO").on("click", function () {
                toastr.info("Espelho NF Sem Transporte", "Copiado!", {
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !6,
                    newestOnTop: !0,
		...
		$("#toastr-success-top-bip").on("click", function () {
                toastr.success("INFORMAÇÕES PARA EMISSÃO DO BIP E NOTA", "Copiado!", {
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !1,
                    newestOnTop: !0,
